...
#define JSUIResourcePickerTypeDefault       0
#define JSUIResourcePickerTypeAllResources  0
#define JSUIResourcePickerTypeResourcesOnly 1
#define JSUIResourcePickerTypeFolderOnly    2
...
@property(nonatomic, retain) id<JSUIResourcePickerDelegate> delegate;
