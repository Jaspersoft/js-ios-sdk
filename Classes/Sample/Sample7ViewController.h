...
@interface Sample7ViewController : UIViewController <UITextFieldDelegate, UITextViewDelegate, JSResponseDelegate, JSUIResourcePickerDelegate> {
    ...
    JSResourceDescriptor *resourceToModify;
