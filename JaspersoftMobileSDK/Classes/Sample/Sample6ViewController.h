...
@interface Sample6ViewController : UIViewController <UIAlertViewDelegate, JSUIResourcePickerDelegate, JSResponseDelegate> {
    
    JSResourceDescriptor *resourceToDelete;
